...
Timeline, volume, editable fields, and dedicated reorder handles opt out of the
scroll fallback because they own their gesture. Wheel, scrollbar, keyboard
scroll, focus, and short button taps remain native.
