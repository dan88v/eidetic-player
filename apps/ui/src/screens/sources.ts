...
export function createSourcesScreen(
  ...
  section.innerHTML = `
    <header class="screen-header"><span class="screen-header__icon">${icon("sources")}</span><div><p class="screen-header__eyebrow">${t("app.name")}</p><h1>${t("screen.sources.title")}</h1><p class="screen-header__description">${t("screen.sources.description")}</p></div></header>
